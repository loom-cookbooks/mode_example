  ...
  context 'on any platform' do
    ...
    it 'creates some files with varying mode parameters' do
      ...
      expect(chef_run).to create_file('/home/vagrant/string_04755.txt')
        .with(mode: '04755')
      expect(chef_run).to create_file('/home/vagrant/integer_655.txt')
        .with(mode: 655)
      expect(chef_run).to create_file('/home/vagrant/integer_0655.txt')
        .with(mode: 0655)
      expect(chef_run).to create_file('/home/vagrant/integer_00655.txt')
        .with(mode: 00655)
      expect(chef_run).to create_file('/home/vagrant/integer_000655.txt')
        .with(mode: 000655)
      expect(chef_run).to create_file('/home/vagrant/integer_04755.txt')
        .with(mode: 04755)
    end
  end
end
